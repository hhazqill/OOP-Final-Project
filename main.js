function buttonClicked() {
    ...
    .then((data) => {
        ...
        document.getElementById('demo12').innerHTML = `Forecast maximum temperature: ${data.forecast.forecastday[0].day.maxtemp_c}°C`;
        document.getElementById('demo13').innerHTML = `Forecast minimum temperature: ${data.forecast.forecastday[0].day.mintemp_c}°C`;
        document.getElementById('demo14').innerHTML = `Forecast maximum wind KM/h: ${data.forecast.forecastday[0].day.maxwind_kph}`;
        document.getElementById('demo15').innerHTML = `The daily change of rain: ${data.forecast.forecastday[0].day.daily_chance_of_rain}%`;
        document.getElementById('demo16').innerHTML = `The daily change of snow: ${data.forecast.forecastday[0].day.daily_chance_of_snow}%`;
        document.getElementById('demo17').innerHTML = `Average Humidity: ${data.forecast.forecastday[0].day.avghumidity}`;
        ...
        document.getElementById('demo20').innerHTML = `Current Humidity: ${data.current.humidity}`;
        document.getElementById('demo21').innerHTML = `Current Temperature: ${data.current.temp_c}°C`;
        document.getElementById('demo22').innerHTML = `Current Wind KM/h: ${data.current.wind_kph}`;
